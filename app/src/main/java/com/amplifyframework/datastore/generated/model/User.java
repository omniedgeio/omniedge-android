...
@ModelConfig(pluralName = "Users", authRules = {
  @AuthRule(allow = AuthStrategy.OWNER, ownerField = "owner", identityClaim = "cognito:username", operations = { ModelOperation.READ, ModelOperation.UPDATE })
})
public final class User implements Model {
  ...
  private final @ModelField(targetType="UserVirtualNetwork") @HasMany(associatedWith = "user", type = UserVirtualNetwork.class) List<UserVirtualNetwork> virtualNetworks = null;
  public String getId() {
      return id;
  }
  ...
  public List<UserVirtualNetwork> getVirtualNetworks() {
